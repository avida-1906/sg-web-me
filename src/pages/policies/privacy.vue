...
<template>
  <div class="content-block pd-24">
    ...
    <div class="p">
      This is the privacy policy of Medium Rare N.V. (owner and operator of Stake.) This Privacy Policy sets out how Stake.com will manage your personal information which we collect as a result of your membership of Stake, your use of our websites located at
      https://stake.com
    ...
    <div class="p">
      Stake.com will collect your Personal Information only by lawful and fair means and not in an intrusive way to operate its business as a licensed online wagering bookmaker for the following purposes:
    </div>
    <ul>
      <li>
        <div class="p">
      ...
      <li>
        <div class="p">
          If you wish to subscribe to Stake.com's marketing communications.
        </div>
      </li>
      <li>
        <div class="p">
          To process your application to become a Member of Stake.com or any managed subdomains.
        </div>
      </li>
      <li>
        <div class="p">
      ...
      <li>
        <div class="p">
          To create aggregate data about Members through demographic profiling, statistical analysis of the database to provide to potential and existing stakeholders, and to allow for more efficient operation of Stake.com’s business.
        </div>
      </li>
      <li>
        <div class="p">
      ...
      <li>
        <div class="p">
          To comply with Stake.com’s contractual, legal, and statutory obligations.
        </div>
      </li>
      <li>
        <div class="p">
          For taking appropriate action if Stake.com has reason to suspect that unlawful activity or misconduct of a serious nature has been, is being or may be engaged in that relates to our functions and activities.
        </div>
      </li>
      <li>
        <div class="p">
    ...
    <div class="p">
      If you do not provide Stake.com with the Personal Information we request, we may be unable to process your application to become a Member, provide you with our services or respond to your enquiry or complaint.
    </div>
    <div class="p">
      By using Stake.com, becoming a Member or otherwise choosing to provide Stake.com with Personal Information you consent to Stake.com collecting, using, processing and potentially disclosing your Personal Information for the above purposes and on the bases described in this Privacy Policy.
    </div>
    <h2>4. Direct Marketing and Opting Out</h2>
    <div class="p">
      From time to time we may use your Personal Information to inform you about our products or services or about promotional activities which Stake.com believes may be of interest or of benefit to you. We may do this via email, SMS, telephone or mail. If you no longer wish to receive marketing or promotional material from Stake.com at all or in any particular form, you may contact us at any time by email to support@stake.com with your request with which we will comply as soon as is practical.
    </div>
    <div class="p">
    ...
    <div class="p">
      Stake.com will destroy or permanently de-identify the Personal Information we hold when it is no longer required for any purpose permitted under the APPs including our legal or operational obligations.
    </div>
    ...
    <div class="p">
      Stake.com’s employees, agents and contractors are required to maintain the confidentiality of Members' Personal Information and trading behavior. Information posted on bulletin boards or communicated within a social media environment (for example, Facebook, Twitter, Chat Rooms) becomes public information. Stake.com cannot guarantee the security of this type of disclosed information.
    </div>
    <div class="p">
